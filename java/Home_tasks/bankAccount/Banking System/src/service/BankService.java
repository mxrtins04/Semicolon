...
public class BankService {
    private final data.repository.AccountRepository accountRepository;
    private final TransactionService transactionService;
    private final String bankCode;

    public BankService(String bankCode, data.repository.AccountRepository accountRepository, TransactionService transactionService) {
